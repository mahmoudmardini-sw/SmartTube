...
import com.liskovsoft.smartyoutubetv2.common.app.presenters.settings.FamilyControlSettingsPresenter;
...
public class AppDataSourceManager {
    ...
    public List<SettingsItem> getSettingItems(Context context) {
        ...
        settingItems.add(new SettingsItem(
                context.getString(R.string.family_control), () -> FamilyControlSettingsPresenter.instance(context).show(), R.drawable.icon_kids_home));
        settingItems.add(new SettingsItem(
